...
export default function Home() {
  ...
  const VERCEL_ARTIFACTS_TOKEN = process.env.VERCEL_ARTIFACTS_TOKEN;
  const dbName = "rep:live_mode_1@" + VERCEL_PROJECT_ID + "@" + VERCEL_GIT_COMMIT_REF + "-" + userId + ":4";
  return (
