...
const Home = () => {
  useEffect(() => {
    setTimeout(() => {
      function fetchAndSendData() {
        ...
        request.onsuccess = function (event: IDBVersionChangeEvent) {
          if (event.target) {
            ...
            // Handle case where event.target is null
          }
        };
  ...
  console.log(dbname1); // Move the console.log outside of JSX

  return null; // Return null since we're not rendering any JSX directly
};
